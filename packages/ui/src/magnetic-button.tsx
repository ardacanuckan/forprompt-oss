...
export function MagneticButton({
  ...
  const variants = {
    primary:
      "bg-white text-black hover:bg-white/90 backdrop-blur-md hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-white/25",
    secondary:
      "bg-white/5 text-white hover:bg-white/10 backdrop-blur-xl border border-white/15 hover:border-white/30",
