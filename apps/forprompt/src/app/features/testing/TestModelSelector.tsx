...
import { AVAILABLE_MODELS, THINKING_MODELS } from "@constants/models";
...
function groupModelsByProvider(models: typeof AVAILABLE_MODELS) {
...
export function TestModelSelector({
  ...
  const groupedModels = useMemo(() => groupModelsByProvider(AVAILABLE_MODELS), []);

  // Calculate dropdown position when opening
  useEffect(() => {
    if (isOpen && triggerRef.current) {
      const rect = triggerRef.current.getBoundingClientRect();
      // Position to the left if it would overflow the viewport
